                                ...
                                <tr>
                                    <td>
                                        <span class="fw-bold"> <a
                                                href="{{ appendQuery('method',@$deposit->gateway->alias) }}">{{ __(@$deposit->gateway->name) }}</a> </span>
                                        <br>
                                    ...
                                    <td>
                                        <span
                                            class="fw-bold">{{ $deposit->user->fullname ?? $deposit->agent->fullname }}</span>
                                        <br>
                                        <span class="small">
                                    <a href="{{ appendQuery('search',@$deposit->user->username ?? @$deposit->agent->username) }}"><span>@</span>{{ $deposit->user->username ?? $deposit->agent->username}}</a>
                                    </span>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        = {{ showAmount($deposit->rate) }} {{__($deposit->method_currency)}}
                                        <br>
