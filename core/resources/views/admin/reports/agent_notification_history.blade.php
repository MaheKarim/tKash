                                ...
                                <tr>
                                    <td>
                                        @if($log->agent)
                                            ...
                                            <br>
                                            <span class="small">
                                                <a href="{{ route('admin.agents.detail', $log->agent_id) }}"><span>@</span>{{ $log->agent->username }}</a>
                                            </span>
                                        @else
                                    ...
                                    <td>
                                        <button class="btn btn-sm btn-outline--primary notifyDetail"
                                                ...
                                                @if($log->notification_type == 'email') data-message="{{ route('admin.report.email.details',$log->id)}}"
                                                @else data-message="{{ $log->message }}"
