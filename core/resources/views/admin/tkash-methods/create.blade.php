...
@section('panel')
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <form action="{{ route('admin.tkash-methods.store') }}" method="POST"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" name="min_trx_limit"
                                                               value="{{ old('min_trx_limit')  }}" required/>
                                                        <span
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" name="max_trx_limit"
                                                               value="{{ old('max_trx_limit') }}" required/>
                                                        <span
                                                            class="input-group-text"> {{ __($general->cur_text) }} </span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" class="form-control"
                                                               ...
                                                               value="{{ old('user_daily_trx_limit')}}"
                                                               required/>
                                                        <span
                                                            class="input-group-text"> {{ __($general->cur_text) }} </span>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" class="form-control"
                                                               ...
                                                               value="{{ old('user_monthly_trx_limit') }}"
                                                               required/>
                                                        <span
                                                            class="input-group-text"> {{ __($general->cur_text) }} </span>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" class="form-control"
                                                               ...
                                                               value="{{ old('agent_daily_trx_limit')}}"
                                                               required/>
                                                        <span
                                                            class="input-group-text"> {{ __($general->cur_text) }} </span>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" class="form-control"
                                                               ...
                                                               value="{{ old('agent_monthly_trx_limit') }}"
                                                               required/>
                                                        <span
                                                            class="input-group-text"> {{ __($general->cur_text) }} </span>
                                                    </div>
