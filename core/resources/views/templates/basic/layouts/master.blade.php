                        ...
                        <div class="col-sm-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h1 class="mt-1 mb-3">{{ showAmount(auth()->user()->balance) }}</h1>
                                    <div class="mb-0">
                                      <span class="text-success"> <i
                                              class="mdi mdi-arrow-bottom-right"></i> {{ showAmount(auth()->user()->balance) }} </span>
                                        <span class="text-muted">Showing total transactions</span>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
